          ...
          <CardContent className="p-3">
            <div className="grid grid-cols-4 gap-1 text-center">
              <div>
                ...
                <p className="text-[10px] text-muted-foreground">服务次数</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-[10px] text-muted-foreground">本月表彰</p>
              </div>
              <div>
                <p className="text-lg font-bold text-violet-600">2680</p>
